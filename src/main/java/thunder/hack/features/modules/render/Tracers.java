...
public class Tracers extends Module {
    ...
    public void onRender3D(MatrixStack stack) {
        for (PlayerEntity player : Managers.ASYNC.getAsyncPlayers()) {
            ...
            double x1 = mc.player.lastX + (mc.player.getX() - mc.player.lastX) * Render3DEngine.getTickDelta();
            double y1 = mc.player.getEyeHeight(mc.player.getPose()) + mc.player.lastY + (mc.player.getY() - mc.player.lastY) * Render3DEngine.getTickDelta();
            double z1 = mc.player.lastZ + (mc.player.getZ() - mc.player.lastZ) * Render3DEngine.getTickDelta();
            ...
            double x = player.lastX + (player.getX() - player.lastX) * Render3DEngine.getTickDelta();
            double y = player.lastY + (player.getY() - player.lastY) * Render3DEngine.getTickDelta();
            double z = player.lastZ + (player.getZ() - player.lastZ) * Render3DEngine.getTickDelta();
